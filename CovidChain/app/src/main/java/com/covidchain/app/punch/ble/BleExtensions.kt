...
package com.covidchain.app.punch.ble
...
const val UUID_COVID_CHAIN = "00002902-0000-1000-8000-00805F9B34FB"
...
fun BluetoothGattDescriptor.isCccd() =
    uuid.toString().toUpperCase(Locale.US) == UUID_COVID_CHAIN.toUpperCase(Locale.US)
